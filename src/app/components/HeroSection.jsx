      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          <p className="text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-2xl">
            ...
            Node.js Express, delivering robust solutions.
          </p>
          <div>
            <Link
              href="/#contact"
        ...
        >
          <div className="rounded-full border border-solid border-orange-500 bg-[#181818] w-[250px] h-[250px] lg:w-[300px] lg:h-[300px] relative overflow-hidden">
            <Image
